...
import { Receipt, Download, Eye, Search, Filter } from 'lucide-react'
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search receipts by course or description..."
                value={searchTerm}
              ...
              {filteredReceipts.length > 0 ? (
                filteredReceipts.map((receipt) => (
                  <tr key={receipt.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{receipt.course}</div>
                      {receipt.mentor && (
                        <div className="text-sm text-gray-500">Mentor: {receipt.mentor}</div>
                      )}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900">
